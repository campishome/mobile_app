...
import 'package:app_2/models/request/TripsDataGetRequest.dart';
import 'package:app_2/pages/login.dart';
import 'package:app_2/pages/profile.dart';
import 'package:app_2/pages/trip.dart';
        ...
        actions: [
          PopupMenuButton<String>(
            onSelected: (value) {
              log(value);
              if(value == 'profile'){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>ProfilePage(idx: widget.idx)));
              }else{
        ...
        children: [
          const Padding(padding: EdgeInsets.only(left:15 ),
            child: SizedBox(
              height: 25,
              width: 200,
              child: Text('ปลายทาง',style: TextStyle(fontSize: 15, color: Colors.black)),
            ),
          ),
                              ...
                              child: SizedBox(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text('ประเทศ ${trip.country}',style: TextStyle(fontSize: 18, color: Colors.black,fontWeight: FontWeight.bold)),
                                      Row(
                                        children: [
                                          Image.network(
                                            '${trip.coverimage}'
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: SizedBox(
                                                    ...
                                                    crossAxisAlignment: CrossAxisAlignment.start,
                                                      children: [
                                                        Text('ประเทศ${trip.country}',style: TextStyle(fontSize: 13,color: Colors.black)),
                                                        Text('ระยะเวลา ${trip.duration} วัน',style: TextStyle(fontSize: 13,color: Colors.black)),
                                                        Text('ราคา ${trip.price} บาท',style: TextStyle(fontSize: 13,color: Colors.black)),
                                                        Padding(
                                                          padding: const EdgeInsets.only(top: 20),
                                                          child:FilledButton(
                                                                    onPressed: () => gotoTrip(trip.idx),
                                                                    child: const Text('รายละเอียดเพิ่มเติม',style: TextStyle(fontSize: 10))
                                                                  )
                                                          )
                                                      ],
                                                    )
